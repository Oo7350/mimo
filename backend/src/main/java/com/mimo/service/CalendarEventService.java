...
public class CalendarEventService {
    ...
    public EventVO create(Long userId, CreateRequest request) {
        ...
        if (request.getProjectId() != null) {
            assertProjectAccess(request.getProjectId(), userId);
        }
    ...
    public List<EventVO> listByUserAndDateRange(
            Long userId, LocalDateTime start, LocalDateTime end, Long projectId) {
    ...
    private void assertProjectAccess(Long projectId, Long userId) {
        ...
        // Check user is a team member of this project's team
